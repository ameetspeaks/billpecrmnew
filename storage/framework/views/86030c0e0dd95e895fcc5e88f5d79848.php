<?php if(Route::is(['store.product-list'])): ?>
    <!-- Add Payroll -->
                    ...
                    <div class="card mb-0">
                        <div class="card-body add-product pb-0 ps-0 pe-0">
                                                                    ...
                                                                    <div class="text-editor add-list add">
                                                                        <div class="col-lg-12">
                                                                            <div class="add-choosen">
                                                                                ...
                                                                                <div class="phone-img">
                                                                                    <img src="<?php echo e(URL::asset('/build/img/products/phone-add-2.png')); ?>"
                                                                                        alt="image">
                                                                                    <a href="javascript:void(0);"><i
                                                                                            data-feather="x"
                                                                                ...
                                                                                <div class="phone-img">
                                                                                    <img src="<?php echo e(URL::asset('/build/img/products/phone-add-1.png')); ?>"
                                                                                        alt="image">
                                                                                    <a href="javascript:void(0);"><i
                                                                                            data-feather="x"
                                                                                            class="x-square-add remove-product"></i></a>
                            ...
                            <div class="btn-addproduct mb-4">
                                <a href="<?php echo e(url('product-list')); ?>" class="btn btn-cancel">Reset</a>
                                        ...
                                        <li class="nav-item nav-searchinputs">
                                            <div class="top-nav-search">
                                                <form action="#" class="dropdown">
                                                    ...
                                                    <!-- <a class="btn"  id="searchdiv"><img src="<?php echo e(URL::asset('/build/img/icons/search.svg')); ?>" alt="img"></a> -->
                                                </form>
                                            </div>
                                        </li>
                                    </ul>
                    ...
                    <div class="content">
                        ...
                        <div class="modal-body custom-modal-body">
                            ...
                            <div class="modal-footer-btn">
                                ...
                                <a href="<?php echo e(url('units')); ?>" class="btn btn-submit">Submit</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="content">
                        ...
                        <div class="modal-body custom-modal-body">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group image-upload-down">
                                        <div class="image-upload download">
                                            <input type="file">
                                            <div class="image-uploads">
                                                <img src="<?php echo e(URL::asset('/build/img/download-img.png')); ?>" alt="img">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="add-choosen mb-3">
                                                    <div class="phone-img ms-0">
                                                        <img src="<?php echo e(URL::asset('/build/img/products/phone-add-2.png')); ?>" alt="image">
                                                        <a href="javascript:void(0);"><i data-feather="x"
                                                                class="x-square-add remove-product"></i></a>
                                                    </div>

                                                    <div class="phone-img">
                                                        <img src="<?php echo e(URL::asset('/build/img/products/phone-add-1.png')); ?>" alt="image">
                                                        <a href="javascript:void(0);"><i data-feather="x"
                                                                class="x-square-add remove-product"></i></a>
                                                    </div>
                                                </div>
                            ...
                            <div class="modal-footer-btn">
                                <a href="javascript:void(0);" class="btn btn-cancel me-2"
                                    data-bs-dismiss="modal">Cancel</a>
                                <a href="<?php echo e(url('warehouse')); ?>" class="btn btn-submit">Submit</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-content">
                <div class="page-wrapper-new p-0">
                    <div class="content">
                        ...
                        <div class="modal-body custom-modal-body">
                            <form action="<?php echo e(url('product-list')); ?>">
                                <div class="row">
                                    <div class="col-lg-4 col-sm-6 col-12">
                                        <div class="input-blocks">
                                            <label>Product</label>
...
<?php if(Route::is(['store.add-product'])): ?>
    <!-- Add Adjustment -->
    <div class="modal fade" id="add-units">
        <div class="modal-dialog modal-dialog-centered stock-adjust-modal">
            <div class="modal-content">
                    ...
                    <div class="content">
                        ...
                        <div class="modal-body custom-modal-body">
                            ...
                            <div class="modal-footer-btn">
                                <a href="javascript:void(0);" class="btn btn-cancel me-2"
                                    data-bs-dismiss="modal">Cancel</a>
                                <a href="<?php echo e(url('add-product')); ?>" class="btn btn-submit">Submit</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php if(Route::is(['store.expired-products'])): ?>
    <!-- Add PDF -->
    <div class="modal fade" id="add-units">
        <div class="modal-dialog modal-dialog-centered custom-modal-two">
            <div class="modal-content">
                <div class="page-wrapper-new p-0">
                    <div class="content">
                        ...
                        <div class="modal-body custom-modal-body">
                            <form action="<?php echo e(url('expired-products')); ?>">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="input-blocks">
...
<?php if(Route::is(['store.low-stocks'])): ?>
    <!-- Send Mail -->
            ...
            <div class="modal-content">
                <div class="page-wrapper-new p-0">
                    <div class="content">
                        ...
                        <div class="modal-body custom-modal-body">
                            <form action="<?php echo e(url('low-stocks')); ?>">
                                <div class="mb-3">
                                    <label class="form-label">Warehouse</label>
...
<?php if(Route::is(['store.category-list'])): ?>
    <!-- Add Category -->
            ...
            <div class="modal-content">
                <div class="page-wrapper-new p-0">
                    <div class="content">
                        ...
                        <div class="modal-body custom-modal-body">
                            <form action="<?php echo e(url('category-list')); ?>">
                                <div class="mb-3">
                                    <label class="form-label">Category</label>
                                    <input type="text" class="form-control">
                                </div>
...
<?php if(Route::is(['store.sub-categories'])): ?>
    <!-- Add Category -->
    <div class="modal fade" id="add-category">
        <div class="modal-dialog modal-dialog-centered custom-modal-two">
            <div class="modal-content">
                <div class="page-wrapper-new p-0">
                    <div class="content">
                        ...
                        <div class="modal-body custom-modal-body">
                            <form action="<?php echo e(url('sub-categories')); ?>">
                                <div class="mb-3">
...
<?php if(Route::is(['store.brand-list'])): ?>
    <!-- Add Brand -->
                ...
                <div class="page-wrapper-new p-0">
                    <div class="content">
                        ...
                        <div class="modal-body custom-modal-body new-employee-field">
                            <form action="<?php echo e(url('brand-list')); ?>">
                                <div class="mb-3">
                                    <label class="form-label">Brand</label>
                                    <input type="text" class="form-control">
                                </div>
                    ...
                    <div class="content">
                        ...
                        <div class="modal-body custom-modal-body new-employee-field">
                            <form action="<?php echo e(url('brand-list')); ?>">
                                ...
                                <div class="profile-pic-upload mb-3">
                                    <div class="profile-pic brand-pic">
                                        <span><img src="<?php echo e(URL::asset('/build/img/brand/brand-icon-02.png')); ?>" alt=""></span>
            ...
            <div class="modal-content">
                <div class="page-wrapper-new p-0">
                    <div class="content">
                        ...
                        <div class="modal-body custom-modal-body">
                            <form action="<?php echo e(url('units')); ?>">
                                <div class="mb-3">
                                    <label class="form-label">Name</label>
                                    <input type="text" class="form-control">
                                </div>
...
<?php if(Route::is(['store.varriant-attributes'])): ?>
    <!-- Add Unit -->
    <div class="modal fade" id="add-units">
        <div class="modal-dialog modal-dialog-centered custom-modal-two">
            <div class="modal-content">
                <div class="page-wrapper-new p-0">
                    <div class="content">
                        ...
                        <div class="modal-body custom-modal-body">
                            <form action="<?php echo e(url('varriant-attributes')); ?>">
                                <div class="mb-3">
                                    <label class="form-label">Name</label>
                                    <input type="text" class="form-control">
                                </div>
...
<?php if(Route::is(['store.warranty'])): ?>
    <!-- Add Warranty -->
    <div class="modal fade" id="add-units">
        <div class="modal-dialog modal-dialog-centered custom-modal-two">
            <div class="modal-content">
                <div class="page-wrapper-new p-0">
                    <div class="content">
                        ...
                        <div class="modal-body custom-modal-body">
                            <form action="<?php echo e(url('warranty')); ?>">
                                <div class="mb-3">
                                    <label class="form-label">Name</label>
                                    <input type="text" class="form-control">
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="barcode-scanner-link text-center">
                                        ...
                                        <div class="barscaner-img">
                                            <img src="<?php echo e(URL::asset('/build/img/barcode/barcode-01.png')); ?>" alt="Barcode"
                                                class="img-fluid">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="barcode-scanner-link text-center">
                                        ...
                                        <p>Price: $300</p>
                                        <div class="barscaner-img">
                                            <img src="<?php echo e(URL::asset('/build/img/barcode/barcode-02.png')); ?>" alt="Barcode"
                                                class="img-fluid">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="modal-body custom-modal-body">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="barcode-scanner-link text-center">
                                        <div class="barscaner-img">
                                            <img src="<?php echo e(URL::asset('/build/img/barcode/qr-code.png')); ?>" alt="Barcode"
                                                class="img-fluid">
                                        </div>
                                        <p>Ref No :32RRR554 </p>
                                    </div>
...
<?php if(Route::is(['store.edit-product'])): ?>
    <!-- Add Adjustment -->
    <div class="modal fade" id="add-units">
        <div class="modal-dialog modal-dialog-centered stock-adjust-modal">
            <div class="modal-content">
...
<?php if(Route::is(['store.call-history'])): ?>
    <!-- details popup -->
                ...
                <div class="page-wrapper details-blk">
                    <div class="content">
                        <div class="text-center right-sidebar-profile mb-3">
                            <figure class="avatar">
                                <img src="<?php echo e(URL::asset('/build/img/users/user-23.jpg')); ?>" alt="image">
                            </figure>
                            <div class="chat-options chat-option-profile">
                                <ul class="list-inline">
                                    <li class="list-inline-item">
                                        <a href="<?php echo e(url('audio-call')); ?>" class="btn btn-outline-light "
                                    ...
                                    <li class="list-inline-item">
                                        <a href="<?php echo e(url('chat')); ?>" class="btn btn-outline-light"
                                            data-bs-toggle="tooltip" data-bs-placement="bottom" title=""
                                    ...
                                    <li class="list-inline-item ">
                                        <a href="<?php echo e(url('video-call')); ?>"
            ...
            <div class="modal-content">
                <div class="page-wrapper-new p-0">
                    <div class="content">
                        ...
                        <div class="modal-body custom-modal-body">
                            <form action="<?php echo e(url('todo')); ?>">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="mb-3">
                    ...
                    <div class="content">
                        <div class="delete-popup">
                            <div class="delete-image text-center mx-auto">
                                <img src="<?php echo e(URL::asset('/build/img/icons/close-circle.png')); ?>" alt="Img" class="img-fluid">
                            </div>
            ...
            <div class="modal-content">
                <div class="page-wrapper-new p-0">
                    <div class="content">
                        ...
                        <div class="modal-body custom-modal-body">
                            <form action="<?php echo e(url('notes')); ?>">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="mb-3">
                                            <label class="form-label">Note Title</label>
...
<?php if(Route::is(['store.file-shared'])): ?>
    <!-- Files Toogle Slide -->
    <div class="toggle-sidebar">
        ...
        <div class="text-center">
            <a href="javascript:void(0);"><img src="<?php echo e(URL::asset('/build/img/file-manager/folder-lg.png')); ?>" alt="Folder"></a>
                        ...
                        <span>
                            <a href="javascript:void(0);" data-bs-toggle="tooltip" data-bs-placement="right"
                                aria-label="Member 1" data-bs-original-title="Member 1"><img
                                    src="<?php echo e(URL::asset('/build/img/avatar/avatar-1.jpg')); ?>" alt="Avatar" class="avatar-md"></a>
                        </span>
                        <span>
                            <a href="javascript:void(0);" data-bs-toggle="tooltip" data-bs-placement="right"
                                aria-label="Member 2" data-bs-original-title="Member 2"><img
                                    src="<?php echo e(URL::asset('/build/img/avatar/avatar-2.jpg')); ?>" alt="Avatar" class="avatar-md"></a>
                        </span>
                        <span>
                            <a href="javascript:void(0);" data-bs-toggle="tooltip" data-bs-placement="right"
                                aria-label="Member 3" data-bs-original-title="Member 3"><img
                                    src="<?php echo e(URL::asset('/build/img/avatar/avatar-3.jpg')); ?>" alt="Avatar" class="avatar-md"></a>
                        </span>
                        <span>
                            <a href="javascript:void(0);" data-bs-toggle="tooltip" data-bs-placement="right"
                                aria-label="Member 4" data-bs-original-title="Member 4"><img
                                    src="<?php echo e(URL::asset('/build/img/avatar/avatar-4.jpg')); ?>" alt="Avatar" class="avatar-md"></a>
                        </span>
                        <span>
                            <a href="javascript:void(0);"
                ...
                <ul class="mb-4">
                    <li class="mb-4">
                        <div class="d-flex align-items-center mb-2">
                            <a href="javascript:void(0);" class="me-3"><img src="<?php echo e(URL::asset('/build/img/avatar/avatar-1.jpg')); ?>"
                        ...
                        <p class="d-flex align-items-center location border-0"><img
                                src="<?php echo e(URL::asset('/build/img/icons/folder.svg')); ?>" alt="Folder" class="me-2">Website Backup for
                            the Design team</p>
                    </li>
                    <li class="mb-4">
                        <div class="d-flex align-items-center mb-2">
                            <a href="javascript:void(0);" class="me-3"><img src="<?php echo e(URL::asset('/build/img/avatar/avatar-2.jpg')); ?>"
                                    alt="Avatar" class="avatar-md"></a>
                    ...
                    <li class="mb-2">
                        <div class="d-flex align-items-center mb-2">
                            <a href="javascript:void(0);" class="me-3"><img src="<?php echo e(URL::asset('/build/img/avatar/avatar-3.jpg')); ?>"
                                    alt="Avatar" class="avatar-md"></a>
                            <div>
                    ...
                    <li class="mb-2">
                        <div class="d-flex align-items-center mb-2">
                            <a href="javascript:void(0);" class="me-3"><img src="<?php echo e(URL::asset('/build/img/avatar/avatar-4.jpg')); ?>"
                                    alt="Avatar" class="avatar-md"></a>
                            <div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-4">
                    <div class="drag-drop text-center mb-4">
                        <div class="upload">
                            <a href="#"><img src="<?php echo e(URL::asset('/build/img/icons/drag-drop.svg')); ?>" alt=""></a>
                    ...
                    <ul>
                        <li class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center w-85">
                                <img src="<?php echo e(URL::asset('/build/img/icons/folder.svg')); ?>" alt="Folder" class="me-2">
                                <div class="flex-fill">
                        ...
                        <li class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center w-85">
                                <img src="<?php echo e(URL::asset('/build/img/icons/xls.svg')); ?>" alt="Folder" class="me-2">
                                <div class="flex-fill">
                        ...
                        <li class="d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center w-85">
                                <img src="<?php echo e(URL::asset('/build/img/icons/zip.svg')); ?>" alt="Folder" class="me-2">
                                <div class="flex-fill">
...
<?php if(Route::is(['store.file-document', 'store.file-favourites', 'store.file-archived'])): ?>
    <!-- Files Toogle Slide -->
    <div class="toggle-sidebar">
        <div class="d-flex align-items-center justify-content-between head">
            <h4>File Preview</h4>
...
<?php if(Route::is(['store.file-recent'])): ?>
    <!-- Files Toogle Slide -->
    <div class="toggle-sidebar">
        <div class="d-flex align-items-center justify-content-between head">
            <h4>File Preview</h4>
                                        ...
                                        <div class="col-lg-12 col-sm-6 col-12">
                                            <div class="input-blocks">
                                                ...
                                                <div class="input-groupicon">
                                                    ...
                                                    <div class="addonset">
                                                        <img src="<?php echo e(URL::asset('/build/img/icons/scanners.svg')); ?>" alt="img">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="productimgname">
                                                                        <a href="javascript:void(0);"
                                                                            ...
                                                                            <img src="<?php echo e(URL::asset('/build/img/products/stock-img-02.png')); ?>"
                                                                                alt="product">
                                                                        </a>
                                                                ...
                                                                <td>
                                                                    <a class="delete-set"><img
                                                                            src="<?php echo e(URL::asset('/build/img/icons/delete.svg')); ?>"
                                                                            alt="svg')}}"></a>
                                                                </td>
                                                            </tr>
                                                        </tbody>
            ...
            <a class="btn btn-submit">Download Sample File</a>
                            ...
                            <div class="col-lg-12">
                                <div class="modal-footer-btn">
                                    <a href="javascript:void(0);" class="btn btn-cancel me-2"
                                        data-bs-dismiss="modal">Cancel</a>
                                    <a href="<?php echo e(url('purchase-list')); ?>" class="btn btn-submit">Submit</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php if(Route::is(['store.sales-list'])): ?>
    <!--add popup -->
                                        ...
                                        <div class="col-lg-12 col-sm-6 col-12">
                                            <div class="input-blocks">
                                                ...
                                                <div class="input-groupicon select-code">
                                                    ...
                                                    <div class="addonset">
                                                        <img src="<?php echo e(URL::asset('/build/img/icons/qrcode-scan.svg')); ?>" alt="img">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="productimgname">
                                                                <a href="javascript:void(0);"
                                                                    class="product-img stock-img">
                                                                    <img src="<?php echo e(URL::asset('/build/img/products/stock-img-03.png')); ?>"
                                                                        alt="product">
                                                                </a>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="productimgname">
                                                                <a href="javascript:void(0);"
                                                                    class="product-img stock-img">
                                                                    <img src="<?php echo e(URL::asset('/build/img/products/stock-img-05.png')); ?>"
                                                                        alt="product">
                                                                </a>
...
<?php if(Route::is(['store.sales-returns'])): ?>
    <!-- add popup -->
    <div class="modal fade" id="add-sales-new">
        <div class="modal-dialog add-centered">
            <div class="modal-content">
                                            ...
                                            <tbody>
                                                    ...
                                                    <td>
                                                        <div class="productimgname">
                                                            <a href="javascript:void(0);" class="product-img">
                                                                <img src="<?php echo e(URL::asset('/build/img/products/product6.jpg')); ?>"
                                                                    alt="product">
                                                            </a>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="productimgname">
                                                            <a href="javascript:void(0);" class="product-img">
                                                                <img src="<?php echo e(URL::asset('/build/img/products/product7.jpg')); ?>"
                                                                    alt="product">
                                                            </a>
                                                            <a href="javascript:void(0);">Apple Earpods</a>
                                                        </div>
...
<?php if(Route::is(['store.quotation-list'])): ?>
    <!--Add Quotation -->
    <div class="modal fade" id="add-units">
        <div class="modal-dialog purchase modal-dialog-centered stock-adjust-modal">
            <div class="modal-content">
                                                    ...
                                                    <div class="add-icon tab">
                                                        <a class="btn btn-filter" data-bs-toggle="modal"
                                                            data-bs-target="#add-units"><img
                                                                src="<?php echo e(URL::asset('/build/img/icons/plus1.svg')); ?>" alt="img">
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="icon-head text-center">
                        <a href="<?php echo e(url('pos-design')); ?>">
                            <img src="<?php echo e(URL::asset('/build/img/logo.png')); ?>" width="100" height="30" alt="Receipt Logo">
                        </a>
                    </div>
                    ...
                    <div class="text-center invoice-bar">
                        <p>**VAT against this challan is payable through central registration. Thank you for your
                            business!</p>
                        <a href="<?php echo e(url('pos-design')); ?>">
                            <img src="<?php echo e(URL::asset('/build/img/barcode/barcode-03.jpg')); ?>" alt="Barcode">
                        </a>
                        <p>Sale 31</p>
                    ...
                    <form action="pos">
                        <div class="product-wrap">
                            <div class="product-list d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center flex-fill">
                                    <a href="javascript:void(0);" class="img-bg me-2">
                                        <img src="<?php echo e(URL::asset('/build/img/products/pos-product-16.png')); ?>" alt="Products">
                                    </a>
                            ...
                            <div class="product-list d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center flex-fill">
                                    <a href="javascript:void(0);" class="img-bg me-2">
                                        <img src="<?php echo e(URL::asset('/build/img/products/pos-product-17.png')); ?>" alt="Products">
                                    </a>
                                    <div class="info d-flex align-items-center justify-content-between flex-fill">
                                        <div>
                                            <span>PT0235</span>
                                    ...
                                    <div class="search-set">
                                        <div class="search-input">
                                            <a class="btn btn-searchset d-flex align-items-center h-100"><img
                                                    src="<?php echo e(URL::asset('/build/img/icons/search-white.svg')); ?>" alt="img"></a>
                                        </div>
                                    </div>
                                    <div class="wordset">
                                        <ul>
                                            <li>
                                                <a class="d-flex align-items-center justify-content-center"
                                                    ...
                                                    title="Pdf"><img src="<?php echo e(URL::asset('/build/img/icons/pdf.svg')); ?>"
                                                        alt="img"></a>
                                            </li>
                                            <li>
                                                <a class="d-flex align-items-center justify-content-center"
                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                    title="Excel"><img src="<?php echo e(URL::asset('/build/img/icons/excel.svg')); ?>"
                                                        alt="img"></a>
                                            </li>
                                            <li>
                                                <a class="d-flex align-items-center justify-content-center"
...
<?php if(Route::is(['store.customers'])): ?>
    <!-- Add Customer -->
    <div class="modal fade" id="add-units">
        <div class="modal-dialog modal-dialog-centered custom-modal-two">
            <div class="modal-content">
                                ...
                                <div class="new-employee-field">
                                    <div class="profile-pic-upload">
                                        <div class="profile-pic people-profile-pic">
                                            <img src="<?php echo e(URL::asset('/build/img/profiles/profile.png')); ?>" alt="Img">
...
<?php if(Route::is(['store.suppliers'])): ?>
    <!-- Add Supplier -->
    <div class="modal fade" id="add-units">
        <div class="modal-dialog modal-dialog-centered custom-modal-two">
            <div class="modal-content">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="new-employee-field">
                                            ...
                                            <div class="profile-pic-upload edit-pic">
                                                <div class="profile-pic">
                                                    <span><img src="<?php echo e(URL::asset('/build/img/supplier/edit-supplier.jpg')); ?>"
                                                            alt=""></span>
                                                    <div class="close-img">
...
<?php if(Route::is(['store.store-list'])): ?>
    <!-- Add Store -->
...
<?php if(Route::is(['store.warehouse'])): ?>
    <!-- Add Warehouse -->
    <div class="modal fade" id="add-units">
        <div class="modal-dialog modal-dialog-centered custom-modal-two">
            <div class="modal-content">
...
<?php if(Route::is(['store.attendance-admin'])): ?>
		<!-- Add Attendance -->
		<div class="modal fade" id="add-units">
			<div class="modal-dialog modal-dialog-centered custom-modal-two">
				<div class="modal-content">
					...
					<div class="page-wrapper-new p-0">
						<div class="content">
							...
							<div class="modal-footer-btn delete">
								...
								<a href="<?php echo e(url('attendance-admin')); ?>" class="btn btn-submit">Delete</a>
							</div>
							</div>
						</div>
					</div>
...
<?php if(Route::is(['store.attendance-employee'])): ?>
		<!-- Add Attendance -->
		<div class="modal fade" id="add-units">
			<div class="modal-dialog modal-dialog-centered custom-modal-two">
				<div class="modal-content">
					...
					<div class="page-wrapper-new p-0">
						<div class="content">
							...
							<div class="modal-body custom-modal-body">
								...
								<div class="modal-footer-btn">
									<a href="javascript:void(0);" class="btn btn-cancel me-2" data-bs-dismiss="modal">Cancel</a>
									<a href="<?php echo e(url('warehouse')); ?>" class="btn btn-submit">Save Changes</a>
								</div>
							</div>
						</div>
					</div>
...
<?php if(Route::is(['store.ban-ip-address'])): ?>
		<!-- Add BanIp -->
...
<?php if(Route::is(['store.bank-settings-grid'])): ?>
		<!-- Add Bank Account -->
...
<?php if(Route::is(['store.bank-settings-list'])): ?>
		<!-- Add Bank Account -->
		<div class="modal fade" id="add-account">
			<div class="modal-dialog modal-dialog-centered custom-modal-two">
				<div class="modal-content">
...
<?php if(Route::is(['store.countires'])): ?>
		<!-- Add Supplier -->
		<div class="modal fade" id="add-units">
			<div class="modal-dialog modal-dialog-centered custom-modal-two">
				<div class="modal-content">
...
<?php if(Route::is(['store.currency-settings'])): ?>
		<!-- Add Currency -->
...
<?php if(Route::is(['store.custom-fields'])): ?>
		<!-- Add Custom Field -->
...
<?php if(Route::is(['store.department-grid','store.department-list'])): ?>
		<!-- Add Department -->
...
<?php if(Route::is(['store.designation'])): ?>
		<!-- Add Department -->
		<div class="modal fade" id="add-department">
			<div class="modal-dialog modal-dialog-centered custom-modal-two">
				<div class="modal-content">
...
<?php if(Route::is(['store.email-settings'])): ?>
		<!-- Php Mail -->
...
<?php if(Route::is(['store.expense-category'])): ?>
					...
					<div class="page-wrapper-new p-0">
						<div class="content">
							...
							<div class="modal-body custom-modal-body">
								...
								<div class="modal-footer-btn">
									<a href="javascript:void(0);" class="btn btn-cancel me-2" data-bs-dismiss="modal">Cancel</a>
									<a href="<?php echo e(url('expense-category')); ?>" class="btn btn-submit">Save Changes</a>
								</div>
							</div>
						</div>
					</div>
...
<?php if(Route::is(['store.expense-list'])): ?>
			<!-- Add Expense -->
			<div class="modal fade" id="add-units">
				<div class="modal-dialog modal-dialog-centered custom-modal-two">
					<div class="modal-content">
						<div class="page-wrapper-new p-0">
							<div class="content">
								...
								<div class="modal-body custom-modal-body">
									...
									<div class="modal-footer-btn">
										<a href="javascript:void(0);" class="btn btn-cancel me-2" data-bs-dismiss="modal">Cancel</a>
										<a href="<?php echo e(url('expense-list')); ?>" class="btn btn-submit">Submit</a>
									</div>
								</div>
							</div>
						</div>
...
<?php if(Route::is(['store.file-manager'])): ?>
	<!-- Files Toogle Slide -->
	<div class="toggle-sidebar">
		<div class="d-flex align-items-center justify-content-between head">
			<h4>File Preview</h4>
		...
		<div class="tab-content" id="nav-tabContent">
			<div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
				...
				<div class="d-flex align-items-center justify-content-between avatar-wrap">
					<div class="avatar-access d-flex align-items-center mb-4">
						<span>
							<a href="javascript:void(0);" data-bs-toggle="tooltip" data-bs-placement="right" aria-label="Member 1" data-bs-original-title="Member 1"><img src="<?php echo e(URL::asset('/build/img/avatar/avatar-1.jpg')); ?>" alt="Avatar" class="avatar-md"></a>
						</span>
						<span>
							<a href="javascript:void(0);" data-bs-toggle="tooltip" data-bs-placement="right" aria-label="Member 2" data-bs-original-title="Member 2"><img src="<?php echo e(URL::asset('/build/img/avatar/avatar-2.jpg')); ?>" alt="Avatar" class="avatar-md"></a>
						</span>
						<span>
							<a href="javascript:void(0);" data-bs-toggle="tooltip" data-bs-placement="right" aria-label="Member 3" data-bs-original-title="Member 3"><img src="<?php echo e(URL::asset('/build/img/avatar/avatar-3.jpg')); ?>" alt="Avatar" class="avatar-md"></a>
						</span>
						<span>
						   <a href="javascript:void(0);" data-bs-toggle="tooltip" data-bs-placement="right" aria-label="Member 4" data-bs-original-title="Member 4"><img src="<?php echo e(URL::asset('/build/img/avatar/avatar-4.jpg')); ?>" alt="Avatar" class="avatar-md"></a>
						</span>
						<span>
			...
			<div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
				...
				<ul class="mb-4">
					<li class="mb-4">
						<div class="d-flex align-items-center mb-2">
							<a href="javascript:void(0);" class="me-3"><img src="<?php echo e(URL::asset('/build/img/avatar/avatar-1.jpg')); ?>" alt="Avatar" class="avatar-md"></a>
							<p>Andrew commented on 1 items <br>3:39 PM Jul 19</p>
						</div>
						<p class="d-flex align-items-center location border-0"><img src="<?php echo e(URL::asset('/build/img/icons/folder.svg')); ?>" alt="Folder" class="me-2">Website Backup for the Design team</p>
					</li>
					<li class="mb-4">
						<div class="d-flex align-items-center mb-2">
							<a href="javascript:void(0);" class="me-3"><img src="<?php echo e(URL::asset('/build/img/avatar/avatar-2.jpg')); ?>" alt="Avatar" class="avatar-md"></a>
							<p>Drake shared an item<br>3:39 PM Jul 19</p>
						</div>
						<p class="d-flex align-items-center location border-0"><img src="<?php echo e(URL::asset('/build/img/icons/folder.svg')); ?>" alt="Folder" class="me-2">Website Backup for the Design team</p>
					</li>
					<li class="mb-2">
						<div class="d-flex align-items-center mb-2">
							<a href="javascript:void(0);" class="me-3"><img src="<?php echo e(URL::asset('/build/img/avatar/avatar-3.jpg')); ?>" alt="Avatar" class="avatar-md"></a>
							<div><p class="mb-0 text-secondary">Melvin</p><p class="mb-0">Commentor</p></div>
						</div>
					</li>
					<li class="mb-2">
						<div class="d-flex align-items-center mb-2">
							<a href="javascript:void(0);" class="me-3"><img src="<?php echo e(URL::asset('/build/img/avatar/avatar-4.jpg')); ?>" alt="Avatar" class="avatar-md"></a>
...
<?php if(Route::is(['store.holidays'])): ?>
		<!-- Add Department -->
		<div class="modal fade" id="add-department">
			<div class="modal-dialog modal-dialog-centered custom-modal-two">
				<div class="modal-content">
...
<?php if(Route::is(['store.leave-types'])): ?>
		<!-- Add coupons -->
		<div class="modal fade" id="add-units">
			<div class="modal-dialog modal-dialog-centered custom-modal-two">
				<div class="modal-content">
...
<?php if(Route::is(['store.leaves-employee'])): ?>
		<!-- Add Leave -->
		<div class="modal fade" id="add-units">
			<div class="modal-dialog modal-dialog-centered custom-modal-two">
				<div class="modal-content">
...
<?php if(Route::is(['store.manage-stocks'])): ?>
		<!-- Add Stock -->
		<div class="modal fade" id="add-units">
			<div class="modal-dialog modal-dialog-centered stock-adjust-modal">
				<div class="modal-content">
																...
																<td>
																	<div class="productimgname">
																		<a href="javascript:void(0);" class="product-img stock-img">
																			<img src="<?php echo e(URL::asset('/build/img/products/stock-img-02.png')); ?>" alt="product">
																		</a>
																		<a href="javascript:void(0);">Nike Jordan</a>
																	</div>												
																</td>
...
<?php if(Route::is(['store.payment-gateway-settings'])): ?>
		<!-- Php Mail -->
...
<?php if(Route::is(['store.printer-settings'])): ?>
		<!-- Add Printer -->
...
<?php if(Route::is(['store.purchase-list'])): ?>
	<!-- Add Purchase -->
	<div class="modal fade" id="add-units">
		<div class="modal-dialog purchase modal-dialog-centered stock-adjust-modal">
			<div class="modal-content">
										...
										<div class="col-lg-3 col-sm-6 col-12">
											<div class="input-blocks">
												...
												<div class="input-groupicon">
													...
													<div class="addonset">
														<img src="<?php echo e(URL::asset('/build/img/icons/calendars.svg')); ?>" alt="img">
													</div>
												</div>
											</div>
										</div>
												...
												<table class="table">
													...
													<tbody>
														<tr>
															...
															<td>
																<a class="delete-set"><img
																		src="<?php echo e(URL::asset('/build/img/icons/delete.svg')); ?>" alt="svg')}}"></a>
															</td>
														</tr>
													</tbody>
												</table>
...
<?php if(Route::is(['store.purchase-returns'])): ?>
			<!--add popup -->
			<div class="modal fade" id="add-sales-new">
				<div class="modal-dialog add-centered">
					<div class="modal-content">
												...
												<table class="table  datanew">
													...
													<tbody>
														<tr>
															<td>
																<a class="product-img">
																	<img src="<?php echo e(URL::asset('/build/img/products/product1.jpg')); ?>" alt="product">
																</a>
															</td>
															<td>2/27/2022</td>
														...
														<tr>
															<td>
																<a class="product-img">
																	<img src="<?php echo e(URL::asset('/build/img/products/product5.jpg')); ?>" alt="product">
																</a>
															</td>
															<td>3/24/2022</td>
...
<?php if(Route::is(['store.roles-permissions'])): ?>
		<!-- Add Role -->
		<div class="modal fade" id="add-units">
			<div class="modal-dialog modal-dialog-centered custom-modal-two">
				<div class="modal-content">
...
<?php if(Route::is(['store.sms-gateway'])): ?>
		<!-- nexmo Config -->
...
<?php if(Route::is(['store.social-authentication'])): ?>
		<!-- Connect Facebook -->
...
<?php if(Route::is(['store.stock-adjustment'])): ?>
		<!-- Add Adjustment -->
		<div class="modal fade" id="add-units">
			<div class="modal-dialog modal-dialog-centered stock-adjust-modal">
				<div class="modal-content">
...
<?php if(Route::is(['store.stock-transfer'])): ?>
		<!-- Add Stock -->
		<div class="modal fade" id="add-units">
			<div class="modal-dialog modal-dialog-centered stock-adjust-modal">
				<div class="modal-content">
...
<?php if(Route::is(['store.storage-settings'])): ?>
		<!-- Aws Config -->
...
<?php if(Route::is(['store.system-settings'])): ?>
		<!-- Google Captcha -->
...
<?php if(Route::is(['store.tax-rates'])): ?>
		<!-- Add Tax Rates -->
									...
									<div class="row">
										<div class="col-lg-12">
											<div class="new-employee-field">
												...
												<div class="profile-pic-upload edit-pic">
													<div class="profile-pic">
														<span><img src="<?php echo e(URL::asset('/build/img/users/edit-user.jpg')); ?>" class="user-editer" alt="User"></span>
														<div class="close-img">
															<i data-feather="x" class="info-img"></i>
														</div>
													</div>
...
<?php if(Route::is(['store.countries'])): ?>
		<!-- Add Supplier -->
		<div class="modal fade" id="add-units">
			<div class="modal-dialog modal-dialog-centered custom-modal-two">
				<div class="modal-content">
		...
		<!-- /Edit Supplier -->
<?php endif; ?><?php /**PATH /home4/billp5kj/public_html/resources/views/store/storeAdmin/components/modalpopup.blade.php ENDPATH**/ ?>