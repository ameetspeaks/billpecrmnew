...
input[type=radio] {
                        ...
                        <ul class="tabs owl-carousel pos-category">
                            <li class="categoryProduct" data-id="all">
                                <!-- <a href="javascript:void(0);">
                                    <img src="<?php echo e(URL::asset('/public/build/img/categories/category-01.png')); ?>" alt="Categories">
                                </a> -->
                                <h6>All Categories</h6>
                                <span><?php echo e(count($products)); ?> Items</span>
                            </li>
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categorie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="categoryProduct" data-id="<?php echo e($categorie->id); ?>">
                                <h6><?php echo e($categorie->name); ?></h6>
                                <span><?php echo e($categorie->products_by_store_count); ?> Items</span>
                            </li>
                                            ...
                                            <div class="product-info default-cover card">
                                                <?php if($product->product_image): ?>
                                                    <a href="javascript:void(0);" class="img-sm">
                                                        <img src="<?php echo e($product->product_image); ?>"
                                                            alt="Products">
                                                        <span><i data-feather="check" class="feather-16"></i></span>
                                                    </a>
                                                <?php else: ?>
                                                    <button type="button" class="btn btn-light"><?php echo e($firstLetter); ?></button>
                                                <?php endif; ?>
                                                <?php if($product->productCategory): ?>
                                                <h6 class="cat-name"><a href="javascript:void(0);"><?php echo e($product->productCategory->name); ?></a></h6>
                                                <?php endif; ?>
                                                <h6 class="product-name"><a href="javascript:void(0);"><?php echo e($product->product_name); ?></a>
                                                </h6>
                                                <div class="d-flex align-items-center justify-content-between price">
                                                    <span><?php echo e($product->stock); ?> Pcs</span>
                                                    <p>₹<?php echo e($product->mrp); ?></p>
                                                </div>
                                                <button class="btn btn-success btn-sm addtoBill" data-id="<?php echo e($product->id); ?>" data-image="<?php echo e($product->product_image); ?>" data-name="<?php echo e($product->product_name); ?>" data-mrp="<?php echo e($product->mrp); ?>" data-qty="<?php echo e($product->quantity); ?>"  data-stock="<?php echo e($product->stock); ?>">Add to purchase</button>
                                            </div>
                                        </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                            ...
                            <div class="input-block d-flex align-items-center">
                                <div class="flex-grow-1">
                                    <select class="js-example-basic-single form-control showCustomer">
                                        ...
                                        <option value="<?php echo e($customer->name); ?>"  data-number="<?php echo e($customer->whatsapp_no); ?>"><?php echo e($customer->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                        ...
                        <div class="block-section payment-method">
                            ...
                            <div class="row d-flex align-items-center justify-content-center">
                                <div class="col-md-6 col-lg-4 item">
                                    <div class="default-cover">
                                        <a href="javascript:void(0);" class="methods">
                                            <img src="<?php echo e(URL::asset('/public/build/img/icons/cash-pay.svg')); ?>"
                                                alt="Payment Method">
                                ...
                                <div class="col-md-6 col-lg-4 item">
                                    <div class="default-cover">
                                        <a href="javascript:void(0);" class="methods">
                                            <img src="<?php echo e(URL::asset('/public/build/img/icons/credit-card.svg')); ?>"
                                                alt="Payment Method">
                                ...
                                <div class="col-md-6 col-lg-4 item">
                                    <div class="default-cover">
                                        <a href="javascript:void(0);" class="methods">
                                            <img src="<?php echo e(URL::asset('/public/build/img/icons/qr-scan.svg')); ?>" alt="Payment Method">
    ...
    <script>
        ...
        $(document).on('click', '.MyToggle', function(){
            ...
            {
                $.ajax({
                    url: "<?php echo e(route('store.pos.getProductByCategory')); ?>",
                    method: 'post',
                    data: { "_token" : "<?php echo e(csrf_token()); ?>", 'catid': catid },
        ...
        function searchProductByname(element) {
            ...
            {
                $.ajax({
                    url: "<?php echo e(route('store.pos.getProductByName')); ?>",
                    method: 'post',
                    data: { "_token" : "<?php echo e(csrf_token()); ?>", 'dInput': dInput },
                    success: function(data){
                        console.log(data)
                        $('#global-loader').hide();
        ...
        $(document).on('click', '.quickAdd', function(){
            ...
            if(stock){
                $('#error-msgstock').text(' ');
                $.ajax({
                    url: "<?php echo e(route('store.pos.quickAddProduct')); ?>",
                    method: 'post',
                    data: { "_token" : "<?php echo e(csrf_token()); ?>", 'product_id': product_id , 'stock': stock},
                    success: function(data){
                        console.log(data)
                        if(data.success == false){
        ...
        $(document).on('click', '.customerAdd', function(){
            ...
            $.ajax({
                url: "<?php echo e(route('store.pos.addCustomer')); ?>",
                method: 'post',
                data: { "_token" : "<?php echo e(csrf_token()); ?>", 'name': name , 'whatsapp_no': whatsapp_no},
                success: function(data){
                    console.log(data)
        ...
        function searchProductBybarcode(element) {
            ...
            {
                $.ajax({
                    url: "<?php echo e(route('store.pos.getProductByBarcode')); ?>",
                    method: 'post',
                    data: { "_token" : "<?php echo e(csrf_token()); ?>", 'dInput': dInput },
                    success: function(data){
                        console.log(data)
        ...
        $('.payment').click(function(){
            ...
            $.ajax({
                url: "<?php echo e(route('store.pos.createBill')); ?>",
                method: 'post',
                data: { "_token" : "<?php echo e(csrf_token()); ?>", 'customerName': customerName, 'customerNumber': customerNumber, 'subtotal': subtotal, 'discount': discount,  'grandtotal': grandtotal, 'payment_method': payment_method, 'product_details': product_details},
                success: function(data){
                    console.log(data)
                    $('#global-loader').hide();
                    $('#billerror').text(' ');
...
<?php echo $__env->make('store.storeAdmin.layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/billp5kj/public_html/resources/views/store/storeAdmin/pos.blade.php ENDPATH**/ ?>