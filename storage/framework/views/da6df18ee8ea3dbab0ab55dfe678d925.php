...
<?php $__env->startSection('content'); ?>
    <div class="page-wrapper">
        <div class="content">
            ...
            <div class="page-header">
                ...
                <div class="page-btn import">
                    <a href="<?php echo e(route('store.product.productExport')); ?>"><button class="btn btn-outline-secondary btn-fw color me-2" id=""><i
            ...
            <!-- /add -->
            <form class="row forms-sample w-full" action="<?php echo e(route('store.product.store')); ?>"  method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group col-md-6 col-12 err_store">
                    ...
                    <select class="form-control h-11 cursor-pointer" id="changeStoreProduct" name="store_id" disabled>
                        ...
                        <?php $__currentLoopData = $stores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $store): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option data-module_id="<?php echo e($store->module_id); ?>" value="<?php echo e($store->id); ?>" <?php echo e(Session::get('store_id') == $store->id ? 'selected':''); ?> ><?php echo e($store->shop_name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                ...
                <!-- <div class="form-group col-md-3 col-12 err_package_weight">
                    ...
                    <select   class="form-control h-11 cursor-pointer package_size" name="package_size" style="background:white !important;width:100%" >
                        ...
                        <?php $__currentLoopData = $attributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attribute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($attribute->name); ?>" data-id="<?php echo e($attribute->id); ?>"><?php echo e($attribute->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div> -->
                ...
                <div class="form-group col-md-6 col-12 err_unit">
                    ...
                    <select   class="form-control h-11 cursor-pointer unit" name="unit" style="background:white !important;width:100%" >
                        ...
                        <?php $__currentLoopData = $unit; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $units): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($units->name); ?>"><?php echo e($units->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
    ...
    <script>
        ...
        $(document).on('change','.category',function()
        {
            ...
            if(id)
            {
                var url = '<?php echo e(route('store.product.getsubCategory',["id" => ":id"])); ?>';
                url = url.replace(':id', id);
                $.ajax({
                    type: 'GET',
                    url: url,
        ...
        $("#productExcel").change(function(){
            ...
            var url = '<?php echo e(route('store.product.uploadProductExcel')); ?>';
            $.ajax({
                headers: {
...
<?php echo $__env->make('store.storeAdmin.layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/billp5kj/public_html/resources/views/store/storeAdmin/add-product.blade.php ENDPATH**/ ?>