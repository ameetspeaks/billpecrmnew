...
<?php $__env->slot('title'); ?> Add New Store <?php $__env->endSlot(); ?>
<?php $__env->slot('subTitle'); ?> Store details <?php $__env->endSlot(); ?>
<?php $__env->slot('content'); ?>
<form class="row forms-sample w-full" action="<?php echo e(route('admin.store.store')); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    ...
    <div class="form-group col-md-6 col-12 err_module_id">
        ...
        <select class="form-control h-11" name="store_type" required>
            ...
            <?php $__currentLoopData = $storeTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $storeType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($storeType->id); ?>" ><?php echo e($storeType->name); ?></option>
...
<?php /**PATH /home4/billp5kj/public_html/resources/views/admin/store/add.blade.php ENDPATH**/ ?>