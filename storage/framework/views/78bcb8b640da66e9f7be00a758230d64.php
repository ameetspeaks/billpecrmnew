...
<?php if(
    ...
    <div class="page-header">
        ...
        <!-- <ul class="table-top-head">
            <li>
                <a data-bs-toggle="tooltip" data-bs-placement="top" title="Pdf"><img
                        src="<?php echo e(URL::asset('/public/build/img/icons/pdf.svg')); ?>" alt="img"></a>
            </li>
            <li>
                <a data-bs-toggle="tooltip" data-bs-placement="top" title="Excel"><img
                        src="<?php echo e(URL::asset('/public/build/img/icons/excel.svg')); ?>" alt="img"></a>
            </li>
            <li>
        ...
        <?php endif; ?>
        <?php if(Route::is(['store.payroll-list'])): ?>
            <div class="page-btn">
        ...
        <?php endif; ?>
        <?php if(Route::is(['store.leaves-admin'])): ?>
            <div class="page-btn">
                <a href="<?php echo e(url('leave-types')); ?>" class="btn btn-added">Leave type</a>
            </div>
        <?php endif; ?>
        ...
        <?php endif; ?>
        <?php if(Route::is(['store.employees-grid'])): ?>
            <div class="page-btn">
        ...
        <?php endif; ?>
        <?php if(Route::is(['store.department-grid'])): ?>
            <div class="page-btn">
                <a href="#" class="btn btn-added" data-bs-toggle="modal" data-bs-target="#add-department"><i
...
<?php if(Route::is([
    ...
    <!-- /Page Header -->
<?php endif; ?>
<?php /**PATH /home4/billp5kj/public_html/resources/views/store/storeAdmin/components/breadcrumb.blade.php ENDPATH**/ ?>