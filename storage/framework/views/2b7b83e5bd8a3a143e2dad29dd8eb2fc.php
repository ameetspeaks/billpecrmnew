        ...
        <div class="container">
            <div class="row text-md-start text-sm-center text-center gap-md-0 gap-sm-4 gap-5" >
                ...
                <div data-aos="fade-down" class="col-md-6 position-relative d-flex flex-column justify-content-center align-items-center mt-md-0 mt-sm-5 mt-4">
                    <img src="<?php echo e(url('public/billpeapp/assets/images/index/hero.png')); ?>" alt="hero_img1" class="moving">
                    <img src="<?php echo e(url('public/billpeapp/assets/images/index/hero_watch.png')); ?>" alt="hero_img2">
                    <img src="<?php echo e(url('public/billpeapp/assets/images/icon/hero_star.png')); ?>" alt="hero_icon">
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="ab_card2 d-flex flex-column justify-content-between" data-aos="flip-right">
                        ...
                        <div
                            ...
                            <div class="position-relative">
                                <img src="<?php echo e(url('public/billpeapp/assets/images/index/about_card_img1.jpg')); ?>" alt="about_img1">
                                <img src="<?php echo e(url('public/billpeapp/assets/images/index/about_card_img2.jpg')); ?>" alt="about_img2">
                            </div>
                            <div class="ps-2">
                                <span>
        ...
        <div class="finanes-card row gap-md-0 gap-sm-4 gap-4">
            <div class="col-lg-4 col-md-4 d-flex justify-content-center pe-lg-3 pe-md-0 pe-sm-3 pe-3">
                <div class="fin-card" data-aos="flip-up">
                    <figure><img src="<?php echo e(url('public/billpeapp/assets/images/icon/graphe.png')); ?>" alt="praph"></figure>
                    <h4>Grow Sales</h4>
            ...
            <div class="col-lg-4 col-md-4 d-flex justify-content-center pe-lg-3 pe-md-0 pe-sm-3 pe-3">
                <div class="fin-card" data-aos="flip-up">
                    <figure> <img src="<?php echo e(url('public/billpeapp/assets/images/icon/doller.png')); ?>" alt="doller"></figure>
                    <h4>Manage Stock</h4>
            ...
            <div class="col-lg-4 col-md-4 d-flex justify-content-center">
                <div class="fin-card" data-aos="flip-up">
                    <figure><img src="<?php echo e(url('public/billpeapp/assets/images/icon/arow.png')); ?>" alt="arow"></figure>
...
<div class="ispsum-logo">
    <div class="container">
        ...
        <div class="logo_ispsum_slider">
            <a href="#">
                <figure><img src="<?php echo e(url('public/billpeapp/assets/images/icon/ipsum-1.png')); ?>" alt="img"></figure>
            </a>
            <a href="#">
                <figure><img src="<?php echo e(url('public/billpeapp/assets/images/icon/ipsum-2.png')); ?>" alt="img"></figure>
            </a>
            <a href="#">
                <figure><img src="<?php echo e(url('public/billpeapp/assets/images/icon/ispum-3.png')); ?>" alt="img"></figure>
            </a>
            <a href="#">
                <figure><img src="<?php echo e(url('public/billpeapp/assets/images/icon/ipsum-4.png')); ?>" alt="img"></figure>
            </a>
            <a href="#">
                <figure><img src="<?php echo e(url('public/billpeapp/assets/images/icon/ipsum-1.png')); ?>" alt="img"></figure>
            </a>
        ...
        <div class="row gap-lg-0 gap-md-0 gap-sm-4 gap-4">
            <div class="col-lg-6 col-md-6 d-flex align-items-center justify-content-center" data-aos="fade-up">
                <div class=" gateway-bg-img mt-5 ">
                    <figure><img src="<?php echo e(url('public/billpeapp/assets/images/index/gateway-1.png')); ?>" alt="gate_img1" class="moving"></figure>
                </div>
            </div>
            <div class="col-lg-6 col-md-6  text-md-start text-sm-center text-center" data-aos="fade-down">
                ...
                <div
                    ...
                    <figure class="d-flex align-items-center"><img src="<?php echo e(url('public/billpeapp/assets/images/icon/gate-icon1.png')); ?>"
                ...
                <div class="gate d-flex mt-4  flex-md-row flex-sm-column flex-column align-items-center">
                    <figure class="d-flex align-items-center"><img src="<?php echo e(url('public/billpeapp/assets/images/icon/gate-icon2.png')); ?>"
                ...
                <div class="gate d-flex mt-4  flex-md-row flex-sm-column flex-column align-items-center">
                    <figure class="d-flex align-items-center"><img src="<?php echo e(url('public/billpeapp/assets/images/icon/gate-icon3.png')); ?>"
        ...
        <div class="row gap-md-0 gap-sm-4 gap-4">
            ...
            <div class="col-lg-6 col-md-6 d-flex align-items-center justify-content-center sevices_img" data-aos="fade-up"> 
                <div class="position-relative">
                    ...
                    <figure><img src="<?php echo e(url('public/billpeapp/assets/images/index/lady-mobile.png')); ?>" alt="sevice_img2"></figure>
                    <figure><img src="<?php echo e(url('public/billpeapp/assets/images/icon/whitStar.png')); ?>" alt="sevice_img3"></figure>
                </div>
            </div>
        </div>
    </div>
...
<section class="visa">
    <div class="container">
        <div class="visa-bg" data-aos="zoom-in">
            <figure><img src="<?php echo e(url('public/billpeapp/assets/images/index/vesa-back.png')); ?>" alt="visa-img"></figure>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="visa-logo d-flex justify-content-between align-items-center pt-2 pb-3">
                        <figure><img src="<?php echo e(url('public/billpeapp/assets/images/icon/vis-1.png')); ?>" alt="vica-icon1"> </figure>
                        <figure><img src="<?php echo e(url('public/billpeapp/assets/images/icon/ves-2.png')); ?>" alt="vica-icon2"></figure>
                        <figure><img src="<?php echo e(url('public/billpeapp/assets/images/icon/ves-3.png')); ?>" alt="vica-icon3"></figure>
                        <figure><img src="<?php echo e(url('public/billpeapp/assets/images/icon/ves-4.png')); ?>" alt="vica-icon4"></figure>
                        <figure><img src="<?php echo e(url('public/billpeapp/assets/images/icon/ves-5.png')); ?>" alt="vica-icon5"></figure>
                    </div>
                    ...
                    <div class="visa-card position-relative mt-3">
                        <img src="<?php echo e(url('public/billpeapp/assets/images/index/Card.png')); ?>" alt="visa-card">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row ">
            <div class="col-lg-6 col-md-6 d-flex align-items-center justify-content-center pricing-bg" data-aos="fade-up">
                <div>
                    <figure><img src="<?php echo e(url('public/billpeapp/assets/images/index/pricinge.png')); ?>" alt="pric-img1" class="moving"></figure>
                            ...
                            <div class="d-flex">
                                <div class="d-flex justify-content-between gap-md-5 gap-sm-3 gap-3">
                                    <div class="d-flex pric-sup align-items-center">
                                        <h2>₹ <?php echo e($subscription->discount_price); ?> </h2>
                                        <p>/ <?php if($subscription->validity_days % 30 == 0): ?> 
                                                Monthly
                                            <?php elseif($subscription->validity_days % 365 == 0): ?> 
                                                Yearly 
                                            <?php else: ?> 
                                                Custom
                                            <?php endif; ?></p>
        ...
        <div class="prof-size"  data-aos="zoom-in-up">
            <div class="prof-slider ">
                <div class="prof-slide position-relative">
                    <div>
                        <div class="d-flex  align-items-center justify-content-center">
                            <img src="<?php echo e(url('public/billpeapp/assets/images/slider/pf2.jpg')); ?>" alt="img" class="prof-img-2">
                        </div>
                        <div>
                             <img src="<?php echo e(url('public/billpeapp/assets/images/slider/Comma.png')); ?>" alt="img" class="prof-img-1">
                        </div>
                ...
                <div class="prof-slide position-relative">
                    <div>
                        <div class="d-flex  align-items-center justify-content-center">
                            <img src="<?php echo e(url('public/billpeapp/assets/images/slider/pf3.jpg')); ?>" alt="img" class="prof-img-2">
                        </div>
                        <div>
                            <img src="<?php echo e(url('public/billpeapp/assets/images/slider/Comma.png')); ?>" alt="img" class="prof-img-1">
                        </div>
                ...
                <div class="prof-slide position-relative">
                    <div>
                        <div class="d-flex  align-items-center justify-content-center">
                            <img src="<?php echo e(url('public/billpeapp/assets/images/slider/profacitional.jpg')); ?>" alt="img" class="prof-img-2">
                        </div>
                        <div>
                            <img src="<?php echo e(url('public/billpeapp/assets/images/slider/Comma.png')); ?>" alt="img" class="prof-img-1">
                        </div>
        ...
        <div class="row d-flex gap-md-0 gap-sm-5 gap-4">
            <div class="col-lg-4 col-md-4 d-flex" data-aos="flip-right">
                <div class="card news-card-back">
                    <img src="<?php echo e(url('public/billpeapp/assets/images/index/news-1.png')); ?>" alt="card-img">
                    <div class="card-body">
                        <a href="#">
            ...
            <div class="col-lg-4 col-md-4 d-flex"  data-aos="flip-right">
                <div class="card news-card-back">
                    <img src="<?php echo e(url('public/billpeapp/assets/images/index/news-2.png')); ?>" alt="image">
                    <div class="card-body">
                        <a href="#">
            ...
            <div class="col-lg-4 col-md-4 d-flex" data-aos="flip-right">
                <div class="card news-card-back">
                    <img src="<?php echo e(url('public/billpeapp/assets/images/index/news-3.png')); ?>" alt="image">
                    <div class="card-body">
                        <a href="#">
...
<?php echo $__env->make('billpeapp.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/billp5kj/public_html/resources/views/billpeapp/index.blade.php ENDPATH**/ ?>