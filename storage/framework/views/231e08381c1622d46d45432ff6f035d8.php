                    ...
                    <div class="col-lg-4 mx-auto">
                        ...
                        <?php endif; ?>
                            ...
                            <h4 class="text-center">Store Register</h4>
                                ...
                                <form class="row forms-sample w-full" action="<?php echo e(route('store.AddNewStore')); ?>" method="POST" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="form-group col-md-6 col-12 err_module_id">
                                        ...
                                        <select class="form-control h-11" name="store_type" required>
                                            ...
                                            <?php $__currentLoopData = $store_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $store_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($store_type->id); ?>" ><?php echo e($store_type->name); ?></option>
                                    ...
                                    <div class="form-group col-6 err_whatsapp_no">
                                        ...
                                        <input type="text" name="whatsapp_no" class="form-control" value="<?php echo e(Session::get('whatsapp_no')); ?>" placeholder="00000000000" readonly>
...
<?php /**PATH /home4/billp5kj/public_html/resources/views/store/registerStore.blade.php ENDPATH**/ ?>