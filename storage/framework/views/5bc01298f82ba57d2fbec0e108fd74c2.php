...
<?php $__env->slot('title'); ?> module <?php $__env->endSlot(); ?>
<?php $__env->slot('subTitle'); ?> module list <?php $__env->endSlot(); ?>
<?php $__env->slot('content'); ?>
<div class="text-right col-12">
    <a href="<?php echo e(route('admin.module.add')); ?>">
...
<script>
   ...
   $(function () {
        var table = $('.table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "<?php echo e(route('admin.module.getDatatable')); ?>",
            ...
            "columns": [
                ...
                },
                {
                    ...
                    "render": function(data, type, row) {
                        console.log(row)
                        return ' <a href=" <?php echo e(url('admin/editModule')); ?>/' + data +'" "><button class="btn btn-success btn-sm">Edit<button></a>';
                    },
                },
    ...
    $(document).on('click','.changeOnlineStatus', function(){
        ...
        $.ajax({
                url: "<?php echo e(route('admin.module.changeOnlineStatus')); ?>",
                method: 'post',
                data: { "_token" : "<?php echo e(csrf_token()); ?>", 'id': id , 'statusName': statusName},
                success: function(data){
                   console.log(data)
...
<?php /**PATH /home4/billp5kj/public_html/resources/views/admin/module/index.blade.php ENDPATH**/ ?>