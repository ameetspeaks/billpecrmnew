...
<?php $__env->startSection('content'); ?>
    <div class="page-wrapper">
        <div class="content">
            <?php $__env->startComponent('store.storeAdmin.components.breadcrumb'); ?>
                ...
                <?php $__env->endSlot(); ?>
                <?php $__env->slot('li_2'); ?>
                    <?php echo e(route('store.add-product')); ?>
    ...
    $(function () {
        var table = $('.table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "<?php echo e(route('store.product.getDatatable')); ?>",
            ...
            "columns": [
                ...
                },
                {
                    ...
                    "render": function(data, type, row) {
                        ...
                        return ' <a href=" <?php echo e(url('store/editProduct')); ?>/' + data +'" " ><i data-feather="edit" class="feather-edit"></i></a><a href="#" id="remove" data-id="'+row.id+'"> <i data-feather="trash-2" class="feather-trash-2"></i></a>';
...
<?php echo $__env->make('store.storeAdmin.layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/billp5kj/public_html/resources/views/store/storeAdmin/product-list.blade.php ENDPATH**/ ?>