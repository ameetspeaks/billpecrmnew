    ...
    <script>
        $(function () {
            var table = $('#example').DataTable({
                ...
                ajax: "<?php echo e(route('store.sales-list')); ?>",
                ...
                "columns": [
                    ...
                    },
                    {
                        ...
                        "render": function(data, type, row) {
                            console.log(row)
                             return ' <a class="action-set" href="javascript:void(0);" data-bs-toggle="dropdown" aria-expanded="true"><i class="fa fa-ellipsis-v" aria-hidden="true"></i></a>  <ul class="dropdown-menu">  <li><a href="<?php echo e(url('store/salesDetail')); ?>/' + data +'" "" ><i data-feather="eye" class="info-img"></i>Sale Detail</a></li>  </ul> ' ;
                        },
                    },
                ],
            });
...
<?php echo $__env->make('store.storeAdmin.layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/billp5kj/public_html/resources/views/store/storeAdmin/sales-list.blade.php ENDPATH**/ ?>