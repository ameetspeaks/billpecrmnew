        ...
        <div class="container">
            <div class="prof-size d-flex flex-column gap-5">
                    <div class="prof-slid position-relative" data-aos="zoom-in-up">
                        <div>
                            <div class="d-flex  align-items-center justify-content-center">
                                <img src="<?php echo e(url('public/billpeapp/assets/images/slider/profational2.jpg')); ?>" alt="img" class="prof-img-2">
                            </div>
                            <div class="pe-3">
                    ...
                    <div class="prof-slid position-relative" data-aos="zoom-in-up">
                        <div>
                            <div class="d-flex  align-items-center justify-content-center">
                                <img src="<?php echo e(url('public/billpeapp/assets/images/slider/profactional3.jpg')); ?>" alt="img" class="prof-img-2">
                            </div>
                            <div class="pe-3">
                                <img src="<?php echo e(url('public/billpeapp/assets/images/slider/Comma.png')); ?>" alt="img" class="prof-img-1">
                            </div>
...
<?php echo $__env->make('billpeapp.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home4/billp5kj/public_html/resources/views/billpeapp/testimonials.blade.php ENDPATH**/ ?>