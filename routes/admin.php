...
Route::group(['as' => 'admin.'], function () {
    ...
    Route::get('active-store-details', [DashboardController::class, 'activeStoreDetails'])->name('dashboard.active-store-details')->middleware('adminLogin');
    Route::get('api-active-store-details', [DashboardController::class, 'activeStoreDetailsApi'])->name('api.dashboard.active-store-details')->middleware('adminLogin');

    Route::get('total-order-details', [DashboardController::class, 'totalOrderDetails'])->name('dashboard.total-order-details')->middleware('adminLogin');
    Route::get('api-total-order-details', [DashboardController::class, 'totalOrderDetailsApi'])->name('api.dashboard.total-order-details')->middleware('adminLogin');

    Route::get('total-fee-details', [DashboardController::class, 'totalFeeDetails'])->name('dashboard.total-fee-details')->middleware('adminLogin');
    Route::get('api-total-fee-details', [DashboardController::class, 'totalFeeDetailsApi'])->name('api.dashboard.total-fee-details')->middleware('adminLogin');

    Route::get('total-order-amount-details', [DashboardController::class, 'totalOrderAmountDetails'])->name('dashboard.total-order-amount-details')->middleware('adminLogin');
    Route::get('api-total-order-amount-details', [DashboardController::class, 'totalOrderAmountDetailsApi'])->name('api.dashboard.total-order-amount-details')->middleware('adminLogin');
