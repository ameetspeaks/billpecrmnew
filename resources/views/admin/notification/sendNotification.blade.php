...
@slot('subTitle') notification list @endslot
@slot('content')
<form action="{{route('admin.notification.send-notification')}}" class="row forms-sample w-full" name="sendNotificationsForm" id="sendNotificationsForm" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="form-group col-md-6 col-12">
        <label for="packageSelect">Select Package:</label>
        <select class="form-control h-11" id="packageSelect" name="package">
    ...
    <div class="form-group col-md-12 col-12 err_store">
        <label for="packageSelect">Title</label>
        <input type="text" placeholder="title" class="form-control" name="title">
    </div> 
    
    <div class="form-group col-md-12 col-12 err_store">
        <label for="packageSelect">Message</label>
        <textarea class="form-control" placeholder="message" name="message"></textarea>
    </div> 
    <div class="form-group col-md-12 col-12 err_image">
    ...
    <div class="form-group col-md-6 col-12 mt-3">
        <button type="submit" class="btn bg-primary text-white">Send Notifications</button>
        <a href="{{ route('admin.notification') }}"><div class="btn btn-light">Cancel</div></a>
    </div>
