...
@slot('title') edit Subscription @endslot
@slot('subTitle') edit Subscription detail @endslot
@slot('content')
<form class="row forms-sample w-full" action="{{ route('admin.subscription.update') }}" method="POST" enctype='multipart/form-data'>
    @csrf
    <input type="hidden" name="packageID" value="{{$package->id}}" >
    <div class="form-group col-4 err_name">
        <label>Name</label>
        <input type="text" name="name" class="form-control" placeholder="New Package" value="{{ $package->name }}">
    ...
    <div class="form-group col-4 err_discription">
        ...
        <input type="text" name="discription" class="form-control" placeholder="Description" value="{{ $package->discription }}">
        <span class="text-xs text-red-500 mt-2 errmsg_discription"></span>
    </div>

    <div class="form-group col-4 err_package_price">
        <label>Package Price</label>
        <input type="text" name="package_price" class="form-control" placeholder="00000" value="{{$package->subscription_price}}">
    </div>

    <div class="form-group col-4 err_discount_price">
        <label>Discount Price</label>
        <input type="text" name="discount_price" class="form-control" placeholder="00000" value="{{$package->discount_price}}">
    ...
    <div class="form-group col-4 err_validity">
        ...
        <input type="number" name="validity" class="form-control" placeholder="00000" value="{{$package->validity_days}}">
    </div>
    ...
    <div class="form-group col-4 err_benefits">
        ...
        <input type="text" name="benefits" class="form-control" placeholder="e.g., value1, value2, value3" value="{{$package->benefitshow}}">
        <span class="text-xs text-red-500 mt-2 err_benefits"></span>
    </div>

    <div class="form-group col-4 err_term_condition">
        <label>Terms & Condition</label>
        <input type="text" name="term_condition" class="form-control" placeholder="Term and Condition" value="{{$package->termsandcondition}}">
        <span class="text-xs text-red-500 mt-2 err_term_condition"></span>
    </div>

    <div class="form-group col-4 err_offer">
        <label>Offer</label>
        <input type="text" name="offer" class="form-control" placeholder="Offer" value="{{$package->offer}}">
    ...
    <div class="form-group col-4 err_extra_brand_coupan">
        ...
        <input type="text" name="extra_brand_coupan" class="form-control" placeholder="Extra Brand Coupan No" value="{{$package->coupan_no}}">
    ...
    <div class="form-group col-4 err_coupan_title">
        ...
        <input type="text" name="coupan_title" class="form-control" placeholder="Coupan Title" value="{{$package->coupan_title}}">
