...
@slot('subTitle') Add Sub units @endslot
@slot('content')
 
<form class="forms-sample w-full row" action="{{ route('admin.subunit.store') }}" method="POST">
    @csrf
    ...
    <div class="form-group col-md-6  err_name">
        <label>Name</label>
        <input type="text" name="name" class="form-control name" placeholder="New Sub Unit Name">
