...
@slot('title') Add Zone @endslot

@slot('subTitle') add Zone detail @endslot
@slot('content')
<form class="row forms-sample w-full" action="{{ route('admin.zone.store') }}" name="moduleData" method="POST">
    @csrf
