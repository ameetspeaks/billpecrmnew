  ...
  ...
    ...
    <nav class="container navbar navbar-expand-lg ">
        <div class="container-fluid">
            <!-- site logo -->
            <a class="nav-logo p-0" href="{{route('index')}}"><img src="{{url('public/billpeapp/assets/images/Logo.png')}}" alt="logo"></a>
                    <!-- navigation button  -->
            ...
            <div class="collapse navbar-collapse " id="navbarSupportedContent">
                <ul
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{  Request::path() == 'index'? 'active' : '' }}" href="{{route('index')}}">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{  Request::path() == 'about'? 'active' : '' }}" href="{{route('about')}}">About us</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{  Request::path() == 'blogs'? 'active' : '' }}" href="{{route('blogs')}}">Blogs</a>
                    </li>
                    <!-- <li class="nav-item">
                    ...
                    <li class="nav-item header_btn ">
                        <a class="nav-link nav-hrf btn-hover1" href="{{route('store.login')}}" target="_blank">Free Trial</a>
                    </li>
    ...
    <aside>
        <div id="mySidenav" class="sidenav">
            <div class="side-nav-logo d-flex justify-content-between align-items-center ps-4 pe-3">
                <figure class="navbar-brand"><a href="{{route('index')}}"><img src="{{url('public/billpeapp/assets/images/Logo.png')}}" alt="img"
            ...
            <ul>
                ...
                <!-- <li class="nav-item">
                    <a class="nav-link {{  Request::path() == 'feature'? 'active' : '' }}" href="{{route('feature')}}">Feature</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{  Request::path() == 'pricing'? 'active' : '' }}" href="{{route('pricing')}}">Pricing</a>
                </li> -->
                <!-- <li class="nav-item">
                    ...
                    <ul id="slid-drop" class="myst">
                        <li><a class="dropdown-item {{  Request::path() == 'contact'? 'active' : '' }}" href="{{route('contact')}}">Contact</a></li>
                        <li><a class="dropdown-item {{  Request::path() == 'blogs'? 'active' : '' }}" href="{{route('blogs')}}">Blogs</a></li>
                        <li><a class="dropdown-item {{  Request::path() == 'faq'? 'active' : '' }}" href="{{route('faq')}}">FAQ</a></li>
    ...
    <section class="right-sidbar" id="right_side">
        <div class="d-flex justify-content-between align-items-center">
            <!-- site logo -->
            <a class="p-0 " href="{{route('index')}}"><img src="{{url('public/billpeapp/assets/images/Logo.png')}}" alt="logo"></a>
