...
<div class="first_nav_hero_about">
    ...
    <section>
        <div class="about-hero container">
            ...
            <p class="text-center about-p">Quick Delivery from nearby.</p>
                    ...
                    <div class="row gap-md-0 gap-sm-4 gap-4">
                        <div class="col-lg-6 col-md-6" data-aos="fade-up">
                            ...
                            <p
                                ...
                                Welcome to ParcelPe, your trusted partner for super-fast, hassle-free deliveries. We are committed to delivering your daily essentials from your favorite nearby stores right to your doorstep in just 10 minutes! Whether it's groceries, fruits, vegetables, or even sweets, we connect you with local merchants to ensure you get what you need, when you need it.


                                .</p>
                            <p class="text-lg-start text-md-start text-sm-center text-center pb-4 ">
                                We work with a variety of local vendors, ensuring that you always have access to fresh products from trusted stores in your area. Our user-friendly app allows you to browse through stores, place orders, and track deliveries in real time, making sure your experience is nothing short of smooth and satisfying.
                                .</p>
                            ...
                            <div
                                ...
                                <a class="btn-hover1" href="https://play.google.com/store/apps/details?id=com.arjhtechlabs.parcelpe">Download the app</a>

                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 d-flex align-items-center justify-content-center abt" data-aos="fade-down">
                            <div class="position-relative">
                                <figure class="abut-hero-img1"><img src="{{url('public/billpeapp/assets/images/index/pp.png')}}" alt="img"></figure>
...
<section class="finance">
    <div class="container text-center">
        <h2>Unlocking the Power of Local Shops with ParcelPe</h2>
        <P class="mt-0">Revolutionize your local shopping with home delivery. Focused on growing local shop with our easy-to-use platform.</P>
