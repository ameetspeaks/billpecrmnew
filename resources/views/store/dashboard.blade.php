...
<style>
    ...
    <link rel="stylesheet" href="{{asset('public\extra\css\desgin.css')}}">
    <div class="container">
        <div>
            <h1 id="storename">{{$storeData->shop_name}}</h1>
        </div>
       
        <div class="row " id="order_stats" style="row-gap: 30px;">
            <div class="col-sm-6 col-lg-3">
                <div class="__dashboard-card-2">
                    <img src="{{ asset('public/admin/images/store.png') }}"
                    alt="dashboard/pharmacy">
                    <h6 class="name">Total number of stores :</h6>
                    <h3 class="count"> {{ $store }}</h3>
                    <div class="subtxt"><b>{{$storeCountToday}}</b> Today Newly added Store</div>
                </div>
            </div>
            <div class="col-sm-6 col-lg-3">
                <div class="__dashboard-card-2">
                    <img src="{{ asset('public/admin/images/transaction-history.png') }}"
                        alt="dashboard/pharmacy">
                    <h6 class="name">Total Bill History :</h6>
                    <h3 class="count">{{ $bill }}</h3>
                    <div class="subtxt"><b>{{$billCountToday}}</b> Today Bill Genrate History</div>
                </div>
            </div>
            <div class="col-sm-6 col-lg-3">
                <div class="__dashboard-card-2">
                    <img src="{{ asset('public/admin/images/money-bag.png') }}"
                      alt="dashboard/pharmacy">
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="__dashboard-card-2">
                    <img src="{{ asset('public/admin/images/people.png') }}"
                    alt="dashboard/pharmacy">
                            ...
                            @foreach ($topSoldItems as $itemName => $soldCount)
                                <a class="grid--card" href="#">
                                    <img class="initial--28"
                                        src="{{ $itemImages[$itemName] ?? 'https://admin.shrimatiji.store/public/assets/admin/img/placeholder-2.png' }}"
                                        onerror="this.src='{{ asset('public/admin/images/default_image.png') }}'"
                                        alt="{{ $itemName }} image">
                                        <div class="cont pt-2">
