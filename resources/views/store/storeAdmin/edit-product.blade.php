...
@section('content')
    <div class="page-wrapper">
        <div class="content">
            ...
            <!-- /edit -->
            <form class="row forms-sample w-full" action="{{ route('store.product.update') }}"  method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group col-md-6 col-12 err_qtn">
                    ...
                    <input type="text" class="form-control" name="qtn" value="{{$package->quantity}}">
                ...
                <div class="form-group col-md-6 col-12 err_stock">
                    ...
                    <input type="text" class="form-control" name="stock" value="{{$package->stock}}">
                ...
                <div class="form-group col-md-6 col-12 err_low_stock">
                    ...
                    <input type="text" class="form-control" name="low_stock" value="{{$package->low_stock}}">
