...
@if (Route::is(['store.expired-products']))
    <!-- Add PDF -->
    <div class="modal fade" id="add-units">
        <div class="modal-dialog modal-dialog-centered custom-modal-two">
            <div class="modal-content">
...
@if (Route::is(['store.edit-product']))
    <!-- Add Adjustment -->
    <div class="modal fade" id="add-units">
        <div class="modal-dialog modal-dialog-centered stock-adjust-modal">
            <div class="modal-content">
...
@if (Route::is(['store.call-history']))
    <!-- details popup -->
...
@if (Route::is(['store.file-document', 'store.file-favourites', 'store.file-archived']))
    <!-- Files Toogle Slide -->
    <div class="toggle-sidebar">
        <div class="d-flex align-items-center justify-content-between head">
            <h4>File Preview</h4>
...
@if(Route::is(['store.attendance-employee']))
		<!-- Add Attendance -->
		<div class="modal fade" id="add-units">
			<div class="modal-dialog modal-dialog-centered custom-modal-two">
				<div class="modal-content">
...
@if(Route::is(['store.ban-ip-address']))
		<!-- Add BanIp -->
...
@if(Route::is(['store.bank-settings-grid']))
		<!-- Add Bank Account -->
...
@if(Route::is(['store.bank-settings-list']))
		<!-- Add Bank Account -->
		<div class="modal fade" id="add-account">
			<div class="modal-dialog modal-dialog-centered custom-modal-two">
				<div class="modal-content">
...
@if(Route::is(['store.currency-settings']))
		<!-- Add Currency -->
...
@if(Route::is(['store.custom-fields']))
		<!-- Add Custom Field -->
...
@if(Route::is(['store.department-grid','store.department-list']))
		<!-- Add Department -->
...
@if(Route::is(['store.email-settings']))
		<!-- Php Mail -->
...
@if(Route::is(['store.file-manager']))
	<!-- Files Toogle Slide -->
	<div class="toggle-sidebar">
		<div class="d-flex align-items-center justify-content-between head">
			<h4>File Preview</h4>
...
@if(Route::is(['store.payment-gateway-settings']))
		<!-- Php Mail -->
...
@if(Route::is(['store.printer-settings']))
		<!-- Add Printer -->
...
@if(Route::is(['store.purchase-list']))
	<!-- Add Purchase -->
	<div class="modal fade" id="add-units">
		<div class="modal-dialog purchase modal-dialog-centered stock-adjust-modal">
			<div class="modal-content">
...
@if(Route::is(['store.social-authentication']))
		<!-- Connect Facebook -->
...
@if(Route::is(['store.storage-settings']))
		<!-- Aws Config -->
...
@if(Route::is(['store.system-settings']))
		<!-- Google Captcha -->
