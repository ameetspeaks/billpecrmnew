...
<div class="header">
    ...
    <div class="header-left active">
        <a href="{{ route('store.dashboard') }}" class="logo logo-normal">
        ...
        <!-- Select Store -->
            ...
            <li class="nav-item dropdown has-arrow flag-nav nav-item-box">
                <select class="form-control changeStore" style="font-weight: bold;" name="store_id">
                    ...
                    <option value="{{$store->id}}" {{Session::get('store_id') == $store->id ? 'selected':''}}><b>{{$store->shop_name}}</b></option>
                    @endforeach
                </select>
            </li>
        <!-- /Select Store -->
    ...
    <div class="dropdown mobile-user-menu">
        ...
        <div class="dropdown-menu dropdown-menu-right">
            ...
            <a class="dropdown-item" href="{{ route('store.logout') }}">Logout</a>
        </div>
    </div>
    <!-- /Mobile Menu -->
</div>
